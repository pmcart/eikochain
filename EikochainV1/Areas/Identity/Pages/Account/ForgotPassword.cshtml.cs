...
namespace EikochainV1.Areas.Identity.Pages.Account
{
    public class ForgotPasswordModel : PageModel
    {
        ...
        public ForgotPasswordModel(UserManager<EikochainUser> userManager, IEmailSender emailSender, IEmailService emailService)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                ...
                _emailService.SendPasswordReset(Input.Email, HtmlEncoder.Default.Encode(callbackUrl));
